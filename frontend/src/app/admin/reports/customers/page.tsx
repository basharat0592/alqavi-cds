        ...
        <div className="max-w-[1400px] mx-auto px-4 py-8 bg-slate-50 dark:bg-[#111213] min-h-screen font-sans">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
                ...
                <div className="flex items-center gap-2">
                    <button onClick={loadData} className="p-3 bg-white border border-slate-200 rounded-xl text-slate-400 hover:text-[#F7CA00] shadow-sm"><RefreshCw className="h-4 w-4" /></button>
                    <button className="flex items-center gap-2 px-5 py-2.5 bg-[#F7CA00] text-white rounded-xl text-[11px] font-black uppercase tracking-widest shadow-xl shadow-blue-500/20 hover:bg-blue-700 transition-all">
            ...
            {/* Top Buyers Matrix */}
            <div className="bg-white dark:bg-[#1B1C1E] border border-slate-200 dark:border-white/10 rounded-xl shadow-sm overflow-hidden mb-12">
                            ...
                            {topBuyers.map((b: any, i) => (
                                <tr key={i} className="hover:bg-slate-50/5 transition-colors group">
                                    <td className="px-6 py-4">
                                        <div className="flex items-center gap-4">
                                            <div className="w-10 h-10 bg-[#F7CA00] rounded-xl flex items-center justify-center font-black text-white text-xs shadow-lg group-hover:rotate-6 transition-all duration-500">
                                    ...
                                    <td className="px-6 py-4 text-right font-black text-[#F7CA00] text-base">{formatCurrency(b.spent)}</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div className="p-8 bg-[#F7CA00] rounded-2xl text-white relative overflow-hidden group shadow-2xl">
                    ...
                    <div className="relative z-10">
                        ...
                        <button className="flex items-center gap-2 px-6 py-3 bg-white text-[#F7CA00] rounded-xl text-[10px] font-black uppercase tracking-widest shadow-xl hover:bg-slate-50 transition-all active:scale-95">
