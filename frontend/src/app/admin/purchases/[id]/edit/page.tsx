            ...
            <div className="flex items-center justify-between mb-8">
                <div>
                    <h1 className="text-2xl font-normal text-gray-900 dark:text-white flex items-center gap-3">
                        <Package className="h-7 w-7 text-[#E68A00]" /> Update Purchase Order
                    </h1>
                    <p className="text-xs text-gray-500 mt-1 uppercase tracking-widest font-black">Modify supplier and product details below</p>
                </div>
                <button onClick={() => router.push('/admin/purchases')} className="text-sm text-gray-400 hover:text-[#C45500] hover:underline flex items-center gap-1">
            ...
            <div className="space-y-6">
                    ...
                    <div className="p-6 grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <input 
                                ...
                                onChange={e => setForm((f: any) => ({ ...f, purchase_number: e.target.value }))} 
                        ...
                        <div>
                            ...
                            <input value={form.supplier_phone} onChange={e => setForm((f: any) => ({ ...f, supplier_phone: e.target.value }))} className={INPUT()} placeholder="+92..." />
                        </div>
                        <div>
                            <label className="block text-[10px] font-black uppercase tracking-wider text-gray-500 mb-1.5">Order Date *</label>
                            <input type="date" value={form.order_date} onChange={e => setForm((f: any) => ({ ...f, order_date: e.target.value }))} className={INPUT(!!errors.order_date)} />
                        </div>
                        <div>
                            <label className="block text-[10px] font-black uppercase tracking-wider text-gray-500 mb-1.5">Expected Delivery</label>
                            <input type="date" value={form.expected_delivery_date} onChange={e => setForm((f: any) => ({ ...f, expected_delivery_date: e.target.value }))} className={INPUT()} />
                        </div>
                        <div>
                        ...
                        <div className="p-6 space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="number" value={form.shipping_cost} onChange={e => setForm((f: any) => ({ ...f, shipping_cost: e.target.value }))} className={INPUT()} />
                                </div>
                                <div>
                                    <label className="block text-[10px] font-black uppercase text-gray-400 mb-1">Tax</label>
                                    <input type="number" value={form.tax_amount} onChange={e => setForm((f: any) => ({ ...f, tax_amount: e.target.value }))} className={INPUT()} />
                                </div>
                            </div>
                ...
                <div className="flex justify-end gap-4 pt-4">
                    ...
                    >
                        ...
                        {saving ? 'Updating Order...' : 'Update Purchase Order'}
                    </button>
                </div>
            </div>
