...
const PageLoader = () => {
    return (
        <div className="fixed inset-0 z-[100000] flex items-center justify-center bg-[#F8FAFC]/90 dark:bg-[#1a252f]/95 transition-colors duration-500 animate-in fade-in">
