...
/* ─────────────────────────────────────────────────────────────────────────────
   ADMIN DESIGN SYSTEM - PURCHASE EDIT PAGE (indigo accent, slate neutrals)
   ───────────────────────────────────────────────────────────────────────────── */
                        ...
                        <Card className="p-8 text-left">
                            ...
                            <div className="grid grid-cols-2 gap-4 mb-6">
                                <button
                                    ...
                                    className={`flex flex-col items-center justify-center p-4 border rounded-xl transition-all gap-2 ${purchase.payment_status?.toUpperCase() === 'PAID' ? 'bg-indigo-50 border-indigo-400 ring-1 ring-indigo-200' : 'bg-white border-slate-200 hover:bg-slate-50'}`}
                                >
                                    <div className={`w-5 h-5 rounded-full border flex items-center justify-center ${purchase.payment_status?.toUpperCase() === 'PAID' ? 'bg-indigo-600 border-indigo-600' : 'border-slate-400'}`}>
                                ...
                                <button
                                    ...
                                    className={`flex flex-col items-center justify-center p-4 border rounded-xl transition-all gap-2 ${purchase.payment_status?.toUpperCase() === 'PARTIAL' ? 'bg-indigo-50 border-indigo-400 ring-1 ring-indigo-200' : 'bg-white border-slate-200 hover:bg-slate-50'}`}
                                >
                                    <div className={`w-5 h-5 rounded-full border flex items-center justify-center ${purchase.payment_status?.toUpperCase() === 'PARTIAL' ? 'bg-indigo-600 border-indigo-600' : 'border-slate-400'}`}>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="relative group">
                                            ...
                                            <label
                                                ...
                                                className="flex flex-col items-center justify-center w-full h-[120px] border-2 border-dashed border-slate-300 rounded-xl cursor-pointer bg-white hover:bg-slate-50 hover:border-indigo-400 transition-all group"
                                            >
                                                {paymentSlip ? (
                                                    ...
                                                    <div className="flex flex-col items-center gap-2">
                                                        ...
                                                        <span className="text-[12px] font-medium text-slate-500">Drag & drop or <span className="text-indigo-600 hover:underline">browse files</span></span>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="space-y-2 pt-2">
                                    <div className="flex justify-between text-[15px] font-bold text-slate-900">
                                        ...
                                        <span className="text-indigo-600 font-black tabular-nums">{formatCurrency(purchase.total_amount)}</span>
                                    </div>
