    ...
    return (
        <div className={cn(positionClassName, "bg-white/95 dark:bg-slate-900/95 backdrop-blur-md border border-slate-200/80 dark:border-white/5 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.15)] z-[100] animate-in fade-in slide-in-from-top-2 duration-200 overflow-hidden text-slate-800 dark:text-slate-100 font-sans")}>
            ...
            <div className="p-4 bg-slate-50/55 dark:bg-white/5 border-b border-slate-100 dark:border-white/5">
                ...
                {/* Status Badge */}
                <div className="flex items-center gap-1.5 px-2.5 py-0.5 bg-[#8A8A86]/10 text-[#8A8A86] dark:bg-[#8A8A86]/15 dark:text-[#B4B4B0] rounded-full border border-[#8A8A86]/20 w-fit">
                ...
                <div className="px-4 py-1">
                    ...
                    <div className="space-y-0.5">
                        <Link href="/admin/settings" onClick={onClose} className="flex items-center justify-between p-2 rounded-xl hover:bg-slate-50 dark:hover:bg-white/5 transition-colors group">
                            <span className="text-[13px] font-medium text-slate-700 dark:text-zinc-300 group-hover:text-[#8A8A86] dark:group-hover:text-[#B4B4B0] transition-colors">Your Profile</span>
                            <ChevronRight size={12} className="text-slate-300 group-hover:translate-x-0.5 transition-transform" />
                        </Link>
                        <Link href="/admin/settings" onClick={onClose} className="flex items-center justify-between p-2 rounded-xl hover:bg-slate-50 dark:hover:bg-white/5 transition-colors group">
                            <span className="text-[13px] font-medium text-slate-700 dark:text-zinc-300 group-hover:text-[#8A8A86] dark:group-hover:text-[#B4B4B0] transition-colors">System Settings</span>
                            <ChevronRight size={12} className="text-slate-300 group-hover:translate-x-0.5 transition-transform" />
                        </Link>
                    </div>
                </div>
                ...
                <div className="px-4 py-1">
                    ...
                    <div className="space-y-0.5">
                        {!isSuper && (
                            <>
                                <Link href="/admin/company/customers" onClick={onClose} className="flex items-center gap-2.5 p-2 rounded-xl hover:bg-slate-50 dark:hover:bg-white/5 transition-colors group">
                                    <Users size={14} className="text-slate-400 dark:text-zinc-500 group-hover:text-[#8A8A86] dark:group-hover:text-[#B4B4B0] transition-colors" />
                                    <span className="text-[13px] font-medium text-slate-700 dark:text-zinc-300 group-hover:text-[#8A8A86] dark:group-hover:text-[#B4B4B0] transition-colors">Customer</span>
                                </Link>
                                <Link href="/admin/company/suppliers" onClick={onClose} className="flex items-center gap-2.5 p-2 rounded-xl hover:bg-slate-50 dark:hover:bg-white/5 transition-colors group">
                                    <Building2 size={14} className="text-slate-400 dark:text-zinc-500 group-hover:text-[#8A8A86] dark:group-hover:text-[#B4B4B0] transition-colors" />
                                    <span className="text-[13px] font-medium text-slate-700 dark:text-zinc-300 group-hover:text-[#8A8A86] dark:group-hover:text-[#B4B4B0] transition-colors">Supplier</span>
                                </Link>
                            </>
                        )}
                        <Link href="/" target="_blank" onClick={onClose} className="flex items-center gap-2.5 p-2 rounded-xl hover:bg-slate-50 dark:hover:bg-white/5 transition-colors group">
                            <ExternalLink size={14} className="text-slate-400 dark:text-zinc-500 group-hover:text-[#8A8A86] dark:group-hover:text-[#B4B4B0] transition-colors" />
                            <span className="text-[13px] font-medium text-slate-700 dark:text-zinc-300 group-hover:text-[#8A8A86] dark:group-hover:text-[#B4B4B0] transition-colors">View Store</span>
                        </Link>
                    </div>
                </div>
