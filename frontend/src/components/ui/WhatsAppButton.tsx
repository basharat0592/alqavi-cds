        ...
        <div className="fixed bottom-10 right-10 z-[50] print:hidden">
            <div className="relative group">
                ...
                <a 
                    ...
                    className="relative flex items-center bg-white/95 dark:bg-black/90 backdrop-blur-3xl border border-slate-100 dark:border-white/5 rounded-[2.5rem] p-1.5 shadow-[0_20px_50px_rgba(0,0,0,0.15)] transition-all duration-700 ease-[cubic-bezier(0.23,1,0.32,1)] hover:shadow-[0_45px_100px_rgba(0,0,0,0.3)] hover:-translate-y-3"
                    aria-label="Chat on WhatsApp"
                >
                    <div className="flex items-center">
                        {/* EXPANDABLE CONTENT (Always Open) */}
                        <div className="flex items-center w-[240px] opacity-100 overflow-hidden transition-all duration-700 ease-[cubic-bezier(0.23,1,0.32,1)]">
                            {/* Part 1: Brand Jewel */}
                        ...
                        <div className="relative group/wa">
                            <div className="w-12 h-12 bg-gradient-to-br from-[#25D366] to-[#128C7E] rounded-[1.2rem] flex items-center justify-center shadow-xl group-hover:rounded-full transition-all duration-700 overflow-hidden border border-white/20">
                                <div className="absolute top-0 left-0 w-full h-[50%] bg-white/25 rounded-b-full pointer-events-none" />
                                <MessageCircle className="w-6 h-6 text-white drop-shadow-md" strokeWidth={2.5} />
                ...
                {/* ── ULTRA-PRO HOVER TOOLTIP (Authorized Badge) ── */}
                <div className="absolute -top-14 left-1/2 -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-all duration-500 translate-y-4 group-hover:translate-y-0 pointer-events-none">
                ...
                {/* Bottom Trust Tag */}
                <div className="absolute -bottom-8 right-12 opacity-30 group-hover:opacity-100 transition-all duration-700 delay-100">
