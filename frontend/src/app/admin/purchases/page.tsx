                            ...
                            return (
                                <button
                                    ...
                                    className={`w-full flex items-center gap-4 px-5 py-2.5 text-[12px] font-bold text-left transition-all
                                        ${isActive ? 'bg-[#F59E0B]/10 text-[#B4780B]' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900 hover:pl-7'}
                                    `}
                                >
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 flex-1 md:flex-initial">
                        ...
                        <div className="flex-1 md:w-[160px] relative">
                            ...
                            <button
                                ...
                                className="w-full h-10 px-3 flex items-center justify-between rounded-xl border border-slate-200 bg-white text-[13px] font-semibold text-slate-700 outline-none focus:border-[#F59E0B] transition-all cursor-pointer select-none text-left"
                            >
                                    ...
                                    <div className="absolute left-0 right-0 mt-1 bg-white border border-slate-200 rounded-xl shadow-lg z-[110] divide-y divide-slate-100 overflow-hidden text-[13px] font-semibold text-slate-700 animate-in fade-in slide-in-from-top-1 duration-150">
                                        {['All', 'unpaid', 'partial', 'paid'].map(val => (
                                            <div
                                                ...
                                                className={`px-4 py-2.5 cursor-pointer hover:bg-slate-50 transition-colors capitalize ${paymentFilter === val ? 'bg-[#F59E0B]/10 text-[#B4780B]' : ''}`}
                                            >
                                ...
                                <>
                                    ...
                                    <div className="absolute left-0 right-0 mt-1 max-h-60 overflow-y-auto bg-white border border-slate-200 rounded-xl shadow-lg z-[110] divide-y divide-slate-100 text-[13px] font-semibold text-slate-700 animate-in fade-in slide-in-from-top-1 duration-150">
                                        <div
                                            ...
                                            className={`px-4 py-2.5 cursor-pointer hover:bg-slate-50 transition-colors ${companyFilter === 'All' ? 'bg-[#F59E0B]/10 text-[#B4780B]' : ''}`}
                                        >
                                            All Companies
                                        </div>
                                        {companies.map((c: any) => (
                                            <div
                                                ...
                                                className={`px-4 py-2.5 cursor-pointer hover:bg-slate-50 transition-colors truncate ${String(companyFilter) === String(c.id) ? 'bg-[#F59E0B]/10 text-[#B4780B]' : ''}`}
                                            >
                                                {c.name}
                                            </div>
                                        ))}
                            ...
                            <Card key={p.id} className="p-4 space-y-3 text-left">
                                ...
                                <div className="flex gap-3">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-center justify-between gap-2">
                                            <h3 className="text-[14px] font-bold text-[#B4780B] hover:text-[#92600A] hover:underline cursor-pointer" onClick={() => handleViewDetails(p.id)}>
                                                #{p.purchase_number}
                                            </h3>
                                ...
                                <div className="grid grid-cols-2 gap-3 py-2.5 border-t border-b border-slate-100 items-center">
                                    ...
                                    <div className="space-y-1 text-right flex flex-col items-end">
                                        ...
                                        <span className={`text-[10px] font-bold uppercase tracking-widest px-2 py-0.5 rounded-full border ${p.payment_status?.toLowerCase() === 'paid' ? 'text-emerald-700 bg-emerald-50 border-emerald-200' : p.payment_status?.toLowerCase() === 'partial' ? 'text-[#B4780B] bg-[#F59E0B]/10 border-[#F59E0B]/25' : 'text-slate-500 bg-slate-50 border-slate-200'}`}>
                                        ...
                                        {(!p.payment_status || p.payment_status.toLowerCase() !== 'paid') && (
                                            <button
                                                ...
                                                className="mt-1 text-[9px] font-bold bg-[#F59E0B] hover:bg-[#B4780B] text-white px-2 py-0.5 rounded-lg shadow-sm transition-all uppercase whitespace-nowrap"
                                            >
                                ...
                                <div className="flex items-center justify-end gap-2.5 pt-2 border-t border-slate-100">
                                    ...
                                    <button
                                        ...
                                        className="text-[12px] font-bold text-[#B4780B] hover:underline inline-flex items-center gap-1"
                                    >
                    ...
                    <table className="w-full text-left border-collapse">
                        ...
                        <tbody className="divide-y divide-slate-100">
                            {loading && filtered.length === 0 ? <tr><td colSpan={8} className="py-20 text-center text-[13px] text-slate-500">Loading purchases...</td></tr> : filtered.length === 0 ? (
                                ...
                                paginated.map((p: any) => (
                                    <tr key={p.id} className="hover:bg-[#B4780B]/40 transition-colors group text-[13px]">
                                        <RowCheckboxTd sel={sel} id={p.id} />
                                        <td className="px-6 py-4">
                                            <div className="w-12 h-12 bg-white rounded-lg border border-slate-200 overflow-hidden flex items-center justify-center group-hover:border-[#F59E0B] transition-colors">
                                                {(() => {
                                                    const img = p.items?.[0]?.product_image;
                                                    return img ? (
                                                        <img src={getImageUrl(img)} className="w-full h-full object-contain p-1" alt="" />
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="font-bold text-[#B4780B] hover:text-[#92600A] hover:underline cursor-pointer" onClick={() => handleViewDetails(p.id)}>#{p.purchase_number}</div>
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex flex-col gap-0.5 items-start">
                                                ...
                                                {(!p.payment_status || p.payment_status.toLowerCase() !== 'paid') && (
                                                    <button
                                                        onClick={(e) => { e.stopPropagation(); setPayModal({ open: true, purchase: p }); }}
                                                        className="mt-1 text-[10px] font-bold bg-[#F59E0B] hover:bg-[#B4780B] text-white px-2.5 py-1 rounded-lg shadow-sm transition-all w-fit uppercase"
                                                    >
                                        ...
                                        <td className="px-6 py-4 text-right">
                                            <div className="flex items-center justify-end gap-2.5 transition-opacity">
                                                ...
                                                <span className="text-slate-300">|</span>
                                                <button onClick={() => router.push(`/admin/purchases/${p.id}/invoice`)} className="text-[12px] font-bold text-[#B4780B] hover:underline inline-flex items-center gap-1"><Printer size={12} /> Print</button>
                                                <span className="text-slate-300">|</span>
                        ...
                        <div className="border-b border-slate-100 px-6 py-4 flex justify-between items-center bg-white shrink-0">
                            <div className="flex flex-col gap-1">
                                <h2 className="text-[16px] font-bold text-slate-900 tracking-tight flex items-center gap-2">
                                    Purchase Order <span className="text-[#B4780B]">#{viewRow.purchase_number}</span>
                                </h2>
                        ...
                        <div className="p-6 flex flex-col lg:flex-row gap-8 overflow-y-auto text-[12px]">
                                            ...
                                            {viewRow.items?.map((item: any) => {
                                                ...
                                                return (
                                                    <tr key={item.id} className="hover:bg-slate-50/50">
                                                        ...
                                                        <td className="px-3 py-2.5 text-right font-bold text-[#B4780B] tabular-nums">{formatCurrency(subtotal)}</td>
                                                    </tr>
                                                );
                                            })}
                                        </tbody>
                                ...
                                <div className="grid grid-cols-2 sm:grid-cols-3 gap-5 mt-5 pt-4 border-t border-slate-100">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center gap-2 flex-wrap">
                                            ...
                                            <span className={`text-[10px] font-bold uppercase tracking-widest px-2 py-0.5 rounded-full border ${(viewRow.payment_status || 'UNPAID').toLowerCase() === 'paid' ? 'text-emerald-700 bg-emerald-50 border-emerald-200' : (viewRow.payment_status || '').toLowerCase() === 'partial' ? 'text-[#B4780B] bg-[#F59E0B]/10 border-[#F59E0B]/25' : 'text-slate-500 bg-slate-50 border-slate-200'}`}>{viewRow.payment_status || 'UNPAID'}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <aside className="w-full lg:w-[340px] lg:border-l lg:border-slate-100 lg:pl-8 shrink-0">
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <div className="flex justify-between font-bold text-slate-900 pt-2 border-t border-slate-100 mt-2 text-[15px]"><span>Total</span><span className="text-[#B4780B] tabular-nums">{formatCurrency(viewRow.total_amount || 0)}</span></div>
                                </div>
                                {(() => {
                ...
                <div className="px-8 py-6 flex justify-between items-center bg-white border-b border-slate-100 shrink-0">
                    <div>
                        ...
                        <p className="text-[13px] text-slate-600 mt-0.5">
                            Purchase Order <span className="font-bold text-[#B4780B]">#{purchase.purchase_number}</span> • {formatCurrency(total)}
                                ...
                                <div className="col-span-2 p-5 bg-slate-50 rounded-xl border border-slate-200 shadow-sm space-y-2.5">
                                    ...
                                    <div className="flex items-center justify-between pt-2.5 border-t border-slate-200">
                                        ...
                                        {paymentStatus === 'PARTIAL' ? (
                                            <div className="flex items-center text-[20px] font-bold text-[#B4780B]">
                                            ...
                                            <span className="text-[20px] font-bold text-[#B4780B] tabular-nums">{formatCurrency(remaining)}</span>
                                        )}
                                    </div>
                                    <div className="flex items-center justify-between pt-2.5 border-t border-slate-200">
