                ...
                <div className="lg:col-span-8 space-y-5">
                    ...
                    <Panel
                        ...
                        action={
                            <button
                                onClick={addItem}
                                className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-[#F59E0B] bg-blue-50 dark:bg-[#F59E0B]/10 rounded-lg hover:bg-blue-100 dark:hover:bg-[#F59E0B]/20 transition-colors"
                            >
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="pt-2">
                                ...
                                <div className="flex justify-between items-center pt-3 border-t border-slate-200 dark:border-white/10 mt-3">
                                    ...
                                    <span className="text-xl font-bold text-[#F59E0B]">{formatCurrency(String(grandTotal))}</span>
                                </div>
                            </div>
                            ...
                            <button
                                onClick={handleSave}
                                disabled={saving}
                                className="w-full py-2.5 bg-[#F59E0B] text-white text-sm font-semibold rounded-lg hover:bg-blue-700 transition-colors flex items-center justify-center gap-2 disabled:opacity-60 shadow-sm mt-2"
                            >
