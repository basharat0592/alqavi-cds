...
// Brand cyan drives the primary CTA; amber is the secondary/attention action.
const variants: Record<Variant, string> = {
    primary: 'bg-[#13B0D1] hover:bg-[#0E8CA8] text-white shadow-sm shadow-[#13B0D1]/30',
    ...
    return (
        <button
            className={cn(
                ...
                'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#13B0D1]/50 focus-visible:ring-offset-2 focus-visible:ring-offset-white',
                variants[variant],
                sizes[size],
                className,
            )}
