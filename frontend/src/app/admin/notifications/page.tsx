                ...
                {[
                    ...
                    <button
                        ...
                        className={cn(
                            ...
                            filter === tab.id ? 'text-indigo-600' : 'text-slate-600 hover:text-slate-900'
                        )}
                    >
                        <tab.icon size={16} />
                        {tab.label}
                        ...
                        {filteredNotifications.map((notif) => {
                            ...
                            return (
                                <div key={notif.id} className="p-5 hover:bg-slate-50 transition-all group flex items-start gap-5">
                                    <div className={cn("w-11 h-11 rounded-xl flex items-center justify-center shrink-0 border border-slate-200 bg-white shadow-sm group-hover:border-indigo-200 transition-colors", colorClass)}>
                                        <Icon size={18} strokeWidth={2.5} />
                                    </div>
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-center justify-between gap-4">
                                            <p className="text-[14px] font-bold text-slate-900 leading-tight group-hover:text-indigo-600 transition-colors">
