...
const PRIMARY_BTN = "bg-[#F59E0B] hover:bg-[#1e40af] text-white font-bold rounded-lg shadow-sm text-[11px] uppercase tracking-widest py-2 px-4 transition-all flex items-center justify-center gap-2 active:scale-95";
...
export default function UsersPage() {
    ...
    return (
        <div className="max-w-[1400px] mx-auto pb-20 px-4 mt-4 font-sans">
                                    ...
                                    filtered.map(user => (
                                        <tr key={user.id} className="hover:bg-slate-50/60 dark:hover:bg-white/[0.02] transition-colors group">
                                            <td className="px-4 py-3">
                                                <div className="flex items-center gap-3">
                                                    <div className="h-8 w-8 bg-slate-100 dark:bg-white/10 text-slate-400 rounded-lg flex items-center justify-center font-bold text-[10px] group-hover:bg-[#F59E0B] group-hover:text-white transition-all">
                                                ...
                                                <div className="flex flex-col gap-1">
                                                    <span className={`inline-block px-2 py-0.5 rounded border text-[10px] font-bold uppercase tracking-tight w-fit
                                                        ${user.role_name?.toLowerCase().includes('admin') 
                                                            ? 'bg-blue-50 text-[#F59E0B] border-blue-100 dark:bg-blue-900/10 dark:border-blue-900/20' 
                                            ...
                                            <td className="px-4 py-3 text-right">
                                                <div className="flex justify-end gap-1">
                                                    ...
                                                    <button onClick={() => router.push(`/admin/users/edit/${user.id}`)} className="p-1.5 text-slate-400 hover:text-[#F59E0B] rounded-md hover:bg-blue-50 dark:hover:bg-blue-900/10 transition-all">
                    ...
                    <div className="bg-white dark:bg-[#1a252f] rounded-xl border border-slate-200 dark:border-white/10 max-w-sm w-full shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300">
                        ...
                        <div className="p-8">
                            <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed font-medium">
                                Confirm permanent removal of <span className="text-[#F59E0B] font-bold">"{deleteUser.first_name} {deleteUser.last_name}"</span> from the system?
                            </p>
                        </div>
            ...
            {/* Al-Qavi premium User Identity Popup */}
            {selectedUserForView && (
                    ...
                    <div className="bg-white dark:bg-slate-900 rounded border border-[#ddd] dark:border-slate-800 max-w-sm w-full shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
                        ...
                        <div className="px-6 py-4 bg-[#f6f6f6] dark:bg-slate-800 border-t border-[#ddd] dark:border-slate-800 flex flex-col gap-2">
                            <button 
                                ...
                                className="w-full bg-[#1a1a2e] hover:bg-[#e2b13c] border border-[#a88734] text-[#111] font-bold py-2 rounded text-xs shadow-sm flex items-center justify-center gap-2"
                            >
