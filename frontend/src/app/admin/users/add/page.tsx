...
const SectionHeader = ({ title, icon: Icon }: { title: string; icon?: any }) => (
    <div className="bg-gradient-to-r from-slate-50 to-white px-6 py-4 border-b border-slate-100 flex items-center gap-3">
        {Icon && (
            <span className="flex items-center justify-center w-8 h-8 rounded-lg bg-[#13B0D1]/10 text-[#0E8CA8] border border-[#13B0D1]/15 shrink-0">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                {getRolePreset(selectedRoleName) && (
                                    <p className="flex items-center gap-1.5 text-[11px] text-[#0E8CA8] font-medium mt-2 bg-[#13B0D1]/60 border border-[#13B0D1]/15 rounded-lg px-2.5 py-1.5">
                            ...
                            {showBranches && (
                                <div className="md:col-span-2 space-y-4 rounded-xl border border-slate-200 bg-slate-50/40 p-5">
                                    <div className="flex items-center gap-2">
                                        <Store className="w-4 h-4 text-[#0E8CA8] shrink-0" />
                    ...
                    {form.role && isFullAccess && (
                        <div className="px-6 pb-4">
                            <div className="flex items-center gap-2 px-4 py-3 bg-[#13B0D1]/10 rounded-lg border border-[#13B0D1]/15">
                                <ShieldCheck className="w-4 h-4 text-[#0E8CA8]" />
                        ...
                        <div className="p-5 space-y-4">
                            <div>
                                ...
                                <div className="mt-1.5 flex items-center gap-2">
                                    ...
                                    />
                                    <button type="button" onClick={() => copy('link', created.loginUrl)} className="h-9 px-3 rounded-lg bg-[#13B0D1] text-white text-[11px] font-bold inline-flex items-center gap-1.5 hover:bg-[#0E8CA8] transition-colors shrink-0">
                            ...
                            <button type="button" onClick={() => copy('invite', created.invite)} className="w-full h-10 rounded-xl border border-[#13B0D1]/25 bg-[#13B0D1]/10 text-[#0E8CA8] text-[12px] font-bold inline-flex items-center justify-center gap-2 hover:bg-[#13B0D1]/15 transition-colors">
