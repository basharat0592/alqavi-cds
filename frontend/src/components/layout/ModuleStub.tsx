                ...
                <div className="bg-[#232F3E] p-10 text-white relative overflow-hidden">
                    <div className="relative z-10">
                        <div className="flex items-center gap-4 mb-4">
                            <div className="w-12 h-12 bg-[#1A1A1A] rounded shadow-lg flex items-center justify-center">
                                <Construction className="w-7 h-7 text-white" />
                            </div>
                            <span className="bg-[#ffffff20] text-[#1A1A1A] px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest border border-[#ffffff10]">
                    ...
                    <div className="absolute top-0 right-0 -mr-16 -mt-16 w-64 h-64 bg-[#1A1A1A]/10 rounded-full blur-3xl" />
                </div>
                ...
                <div className="p-12 text-center border-b border-[#D5D9D9]">
                    <div className="max-w-md mx-auto">
                        ...
                        <div className="flex items-center justify-center gap-4">
                            <Link href="/admin/dashboard" className="px-8 py-3 bg-[#1A1A1A] border border-[#a88734] text-gray-900 font-black text-xs uppercase tracking-widest rounded hover:bg-[#F0982D] transition-all shadow-md active:scale-95 flex items-center gap-2">
                        ...
                        {[
                            ...
                            <div key={i} className="bg-white border border-[#D5D9D9] p-5 rounded shadow-sm">
                                <div className="flex items-center justify-between mb-3">
                                    <span className="text-[10px] font-black text-[#1A1A1A] uppercase tracking-widest">Phase {item.step}</span>
