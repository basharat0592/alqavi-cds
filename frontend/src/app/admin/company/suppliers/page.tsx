...
import { PageHeader, Card, Button, Badge, ui, useTableSelection, SelectAllTh, RowCheckboxTd, BulkBar, TableShell, Pagination, RowActions } from '@/components/admin/ui';
                    ...
                    {filtered.length === 0 ? (
                        ...
                        paginatedItems.map(s => (
                            <Card key={s.id} className="p-4 space-y-3 text-left">
                                ...
                                {/* Row 4: Controls */}
                                <RowActions items={[
                                    { label: 'View', onClick: () => setSelectedForView(s) },
                                    { label: 'Edit', onClick: () => openEdit(s) },
                                    { label: 'Delete', onClick: () => setDeleteItem(s), danger: true },
                                ]} />
                            </Card>
                        ))
                    )}
                    ...
                    <div className="hidden md:block overflow-x-auto">
                        <table className={ui.table}>
                            <thead>
                                <tr>
                                    <SelectAllTh sel={sel} />
                                    <th className={ui.th}>Supplier Detail</th>
                                    <th className={ui.th}>Phone & Email</th>
                                    <th className={ui.th}>Location</th>
                                    <th className={ui.th + ' text-center'}>Working</th>
