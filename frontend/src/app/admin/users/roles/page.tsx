                                    ...
                                    filtered.map(role => (
                                        <tr key={role.id} className="group hover:bg-white group hover:bg-slate-50/60 dark:hover:bg-white/[0.02] transition-colors">
                                            <td className="px-4 py-3">
                                                <div className="flex items-center gap-3">
                                                    <div className="h-9 w-9 bg-slate-100 dark:bg-white/10 border border-slate-200 dark:border-white/10 rounded-lg flex items-center justify-center font-bold text-[#F7CA00] text-sm group-hover:bg-[#F7CA00] group-hover:text-white group-hover:border-[#F7CA00] transition-all">
                                            ...
                                            <td className="px-4 py-3 text-left">
                                                {role.is_default ? (
                                                    <span className="inline-flex items-center px-2 py-0.5 rounded border border-blue-200 bg-blue-50 text-[#F7CA00] text-[10px] font-bold uppercase tracking-tight">
                                                        Core Default
                                                    </span>
                                                ) : (
                                            ...
                                            <td className="px-4 py-3 text-right">
                                                <div className="flex items-center justify-end gap-1">
                                                    <Link href={`/admin/users/roles/${role.id}/edit`} className="p-1.5 text-slate-400 hover:text-[#F7CA00] rounded-md hover:bg-blue-50 dark:hover:bg-blue-900/10 transition-all">
                    ...
                    <div className="bg-white dark:bg-[#1B1C1E] rounded-xl border border-slate-200 dark:border-white/10 max-w-sm w-full shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300">
                        ...
                        <div className="p-8">
                            <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed font-medium">
                                Confirm permanent removal of the security tier <span className="text-[#F7CA00] font-bold">"{deleteRole.name}"</span>?
                            </p>
                        </div>
