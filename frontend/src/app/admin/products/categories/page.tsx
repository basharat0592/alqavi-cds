                            ...
                            {loading && filtered.length === 0 ? (
                                ...
                                filtered.map((cat) => (
                                    <tr key={cat.id} className="hover:bg-slate-50/60 dark:hover:bg-white/[0.02] transition-colors group">
                                        ...
                                        <td className="px-4 py-3">
                                            <span className={`px-2 py-0.5 rounded border text-[11px] font-semibold uppercase ${cat.status?.toLowerCase() === 'active' ? 'bg-emerald-50 dark:bg-emerald-500/10 text-emerald-700 dark:text-emerald-400 border-emerald-200 dark:border-emerald-500/20' : 'bg-slate-50 text-slate-400 border-slate-200'}`}>
                                                {cat.status || 'Active'}
                                            </span>
                                        </td>
