...
import {
    Clock, Warehouse, Printer, Wallet, Package, Phone, MapPin, Store, Globe, ArrowLeft, Trash2, User, FileText, Check, X, Paperclip, ExternalLink
} from 'lucide-react';
    ...
    return (
        <div className="pb-24 text-left font-sans text-slate-800 bg-[#f8fafc] min-h-screen">
            <div className="max-w-[1200px] mx-auto px-4 md:px-8 pt-6">
                ...
                {/* Back Link */}
                <Link href="/admin/sales" className="inline-flex items-center gap-1.5 text-slate-500 hover:text-slate-800 text-[13px] font-semibold mb-4 transition-colors">
                                                ...
                                                <td className="px-6 py-3.5 text-right space-x-2.5 whitespace-nowrap" onClick={(e) => e.stopPropagation()}>
                                                    {pm.slip_url && (
                                                        <a 
                                                            ...
                                                            target="_blank" 
                                                            rel="noreferrer" 
                                                            className="text-slate-400 hover:text-indigo-600 inline-block align-middle"
                                                            title="View Slip"
                                                        >
                                                            <Paperclip size={14} />
                                                        </a>
                                                    ...
                                                    {pm.status === 'pending' && (
                                                        <>
                                                            <button 
                                                                ...
                                                                className="text-xs font-bold text-emerald-600 hover:text-emerald-700 hover:underline inline-block align-middle animate-pulse"
                                                                title="Verify & Confirm"
                                                            >
                                                                Verify
                                                            </button>
                                                            <button 
                                                                onClick={() => handleRejectPayment(pm.id)}
                                                                className="text-xs font-bold text-rose-600 hover:text-rose-700 hover:underline inline-block align-middle"
                                                    ...
                                                    <button 
                                                        ...
                                                        className="text-slate-300 hover:text-rose-600 inline-block align-middle"
                                                        title="Delete Record"
                                                    >
                                                        <Trash2 size={13} />
                                                    </button>
                ...
                >
                    <div className="space-y-5 text-left text-sm font-sans text-slate-800">
                        ...
                        {selectedInstallment.slip_url && (
                            <div className="border-t border-slate-100 pt-4">
                                ...
                                <div className="bg-slate-50 p-2 rounded-lg border border-slate-200 flex flex-col items-center">
                                    ...
                                    <a 
                                        href={selectedInstallment.slip_url} 
                                        target="_blank" 
                                        rel="noreferrer"
                        ...
                        <div className="flex justify-between items-center gap-3 border-t border-slate-100 pt-4">
                            <button
                                onClick={() => handleDeletePayment(selectedInstallment.id)}
                                className="h-10 px-4 bg-rose-50 hover:bg-rose-100 text-rose-600 font-bold border border-rose-200 rounded-lg text-xs sm:text-[13px] flex items-center gap-1.5 transition-colors"
                            >
                                <Trash2 size={14} /> Delete
                            </button>
                            ...
                            <div className="flex gap-2">
                                ...
                                {selectedInstallment.status === 'pending' && (
                                    <>
                                        <button 
                                            onClick={() => handleRejectPayment(selectedInstallment.id)}
                                            className="h-10 px-4 bg-rose-600 hover:bg-rose-700 text-white font-bold rounded-lg text-xs sm:text-[13px] transition-colors"
                                        >
                                            Reject
                                        </button>
                                        <button 
                                            onClick={() => handleConfirmPayment(selectedInstallment.id)}
                                            className="h-10 px-4 bg-emerald-600 hover:bg-emerald-700 text-white font-bold rounded-lg text-xs sm:text-[13px] transition-colors"
                                        >
                                            Confirm & Verify
                                        </button>
                                    </>
