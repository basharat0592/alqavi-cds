    ...
    return (
        <div className="pb-10">
            ...
            <Card className="p-5 mb-6">
                <h3 className="text-[13px] font-bold text-slate-900 mb-4 flex items-center gap-2"><CalendarClock size={15} className="text-indigo-500" /> Aging</h3>
                        ...
                        {sorted.length === 0 ? (
                            ...
                            <tr key={i} className="hover:bg-slate-50 transition-colors text-[13px] group">
                                ...
                                <td className="px-6 py-4 text-right no-print">
                                    <Link href={cfg.link(r.type)} className="inline-flex items-center gap-1 text-[12px] font-bold text-indigo-600 hover:underline">
