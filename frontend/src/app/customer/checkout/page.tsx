    ...
    if (items.length === 0) {
        return (
            <div className="min-h-screen bg-[#F8F9FA] flex flex-col items-center justify-center p-8 text-center">
                ...
                <Link href="/customer" className="px-10 py-2.5 bg-[#f0c14b] text-[#111] font-bold rounded-[3px] border border-[#a88734] shadow-sm">Browse Products</Link>
            </div>
        );
    }
                            ...
                            <div className="p-6 space-y-3">
                                {[
                                    ...
                                    <div key={m.id} className="space-y-3">
                                        <label className={`block p-4 border rounded-[4px] cursor-pointer transition-all ${payMethod === m.id ? 'border-[#e77600] bg-[#fcf5ee]' : 'border-[#ddd] hover:bg-[#f7f8fa]'}`}>
                                                ...
                                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                                    {[
                                                        ...
                                                        <button
                                                            ...
                                                            className={`p-3 text-left border rounded-[4px] transition-all ${selectedEasypaisaNum === acc.num ? 'border-[#e77600] bg-[#fcf5ee] ring-1 ring-[#e77600]' : 'border-[#ddd] hover:bg-gray-50'}`}
                                                        >
                                                    ...
                                                    <div className="pt-4 border-t border-dashed border-[#ddd] space-y-3">
                                                        ...
                                                        <div className="flex flex-col sm:flex-row gap-4">
                                                            <label className="flex-1 cursor-pointer">
                                                                <div className="h-[100px] border-2 border-dashed border-[#ddd] rounded-[8px] flex flex-col items-center justify-center gap-2 hover:border-[#e77600] hover:bg-[#fcf5ee] transition-all bg-gray-50">
                                                                    {receiptPreview ? (
                        ...
                        <div className="p-8 space-y-8 overflow-y-auto max-h-[calc(90vh-140px)]">
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <p className="text-[13px] capitalize font-bold text-[#B12704]">{payMethod.replace('cod', 'Cash on Delivery')}</p>
